...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            <label>Codigo </label>
            <input  type="text" wire:model.lazy="barcode" class="form-control" placeholder="Ej : 0113615">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            <label>Stock </label>
            <input  type="number" wire:model.lazy="stock" class="form-control" placeholder="Ej : 2">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            ...
            <input  type="number" wire:model.lazy="alerts" class="form-control" placeholder="Ej : 1">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="form-group custom-file">
            <input  type="file" class="custom-file-input" wire:model="image" accept="image/x-png,image/gif,image/jpeg,image/jpg">
