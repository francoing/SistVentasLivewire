    ...
    (function(g) {
        ...
        k.prototype = {
            ...
            createDropdown: function() {
                ...
                var r = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="modalDetails.blade.php-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + l(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search"></div>' : "";
            ...
            liHeight: function(t) {
                ...
                if (y) {
                    ...
                    B.className = "modalDetails.blade.php-control";
                    y.appendChild(B);
                    n.appendChild(y)
                }
                if (z) {
