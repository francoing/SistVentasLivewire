  ...
  $.fn.extend({
    maxlength: function (options, callback) {
      ...
      */
      ...
      /**
       * Returns how many chars are left to complete the fill up of the modalDetails.blade.php.
       *
       * @param input
       * @param maxlength
       * @return {number}
      ...
      */
      ...
      function manageRemainingVisibility(remaining, currentInput, maxLengthCurrentInput, maxLengthIndicator) {
        ...
        if (options.customMaxAttribute) {
          // class to use for modalDetails.blade.php validation on custom maxlength attribute
          if (remaining < 0) {
